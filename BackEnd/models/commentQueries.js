...
const removeCommentByStudentId = "DELETE FROM comments WHERE student_id = $1";
const removeCommentByTutorId = "DELETE FROM comments WHERE tutor_id = $1";
...
module.exports = {
    ...
    addComment,
    removeComment,
    removeCommentByStudentId,
    removeCommentByTutorId,
}